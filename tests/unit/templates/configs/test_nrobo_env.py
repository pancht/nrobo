...
def test_existing_nrobo_env_content_matches_expected():
    # Path to the actual existing .nrobo_env file
    env_file = settings.BASE_DIR / "nrobo" / "templates" / "configs" / ".nrobo_env"
